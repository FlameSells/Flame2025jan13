...
async def main():
    ...
    try:
        ...
        for i in range(1, num_sessions + 1):
            ...
            print("\nSelect the action to perform for this session:")
            ...
            rounds = None
            delay_between_rounds = None

            if option == 1:
                rounds = int(input("How many times do you want to forward messages for this session? "))
                delay_between_rounds = int(input("Enter delay (in seconds) between rounds for this session: "))

            await login_and_execute(api_id, api_hash, phone_number, session_name, option, rounds, delay_between_rounds)
